        ...
        <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12 ">
                    <a href="#" class="text-sm font-semibold leading-6 text-indigo-700" onclick="scrollToSection('about-section')">About</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-indigo-700" onclick="scrollToSection('system-section')">Benefit</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-indigo-700" onclick="scrollToSection('stats-section')">Stats</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-indigo-700" onclick="scrollToSection('reviews-section')">Reviews</a>
                    <a href="#" class="text-sm font-semibold leading-6 text-indigo-700" onclick="scrollToSection('teams-section')">Teams</a>
                </div>
            ...
            <div class="mx-auto max-w-2xl lg:py-36 flex lg:flex-row-reverse items-start">
                ...
                <div class="text-start">
                    <h1 class="text-4xl font-bold tracking-tight text-indigo-950 sm:text-5xl">Connecting <br> around us.
                        <br> <span class="text-indigo-400">with KRENT</span>
                    </h1>
        ...
        <section>
            <div id="system-section" class="h-full py-8 px-8 mx-auto md:px-12 lg:px-12 max-w-7xl">
                ...
                <div class="grid grid-cols-2 text-center lg:grid-cols-4 lg:gap-x-12 lg:gap-y-4 py-6 lg:px-36">
                    <div>
                        <div>
                            <span class="flex items-center justify-center w-12 h-12 mx-auto rounded-full bg-zinc-100"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="w-6 h-6 text-zinc-600">
