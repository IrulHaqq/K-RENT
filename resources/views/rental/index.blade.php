...
@section('content')
    <div class="container mx-auto p-5">
        ...
        <form id="rentalForm" action="{{ route('rental.update', ['id' => $rental->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="number" name="total_cost" id="total_cost" value="{{ $rental->total_cost }}" class="form-input mt-1 block w-full" disabled>
            </div>
        </form>
